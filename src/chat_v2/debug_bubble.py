# Debug Bubble V2 - 可折叠的调试信息气泡
# 改进:
# - 支持内容更新（追加模式，同一 debug_type 可多次更新）
# - 更好的折叠/展开动画
# - 右键复制
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QLabel,
    QPushButton, QFrame, QTextBrowser, QGraphicsDropShadowEffect, QMenu
)
from PySide6.QtCore import Qt, QPropertyAnimation, QEasingCurve
from PySide6.QtGui import QFont, QColor, QAction

from chat_v2.markdown_renderer import render_markdown, DEBUG_CSS
...
class DebugBubble(QWidget):
    ...
    def _show_context_menu(self, pos):
        ...
        expand_action = QAction("展开" if not self._expanded else "折叠", self)
